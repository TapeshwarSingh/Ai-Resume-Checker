...
const { diffText } = require("../services/diffService");
...
router.post(
  ...
  asyncHandler(async (req, res) => {
    ...
    // with the chosen bullets swapped in, so V2 never lands with
    // empty sections even if Gemini's re-parse fails.
